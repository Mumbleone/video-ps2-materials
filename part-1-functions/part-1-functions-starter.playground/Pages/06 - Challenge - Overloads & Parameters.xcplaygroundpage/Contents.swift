...
func multiply(number: Int, by multiplier: Int, subtractBy: Int) -> Int {
  return number * multiplier - subtractBy
}
func multiply(number: Int, by multiplier: Int, addBy: Int) -> Int {
  return number * multiplier - addBy
}
/*:
 ## Challenge 2
